...
import kotlinx.android.synthetic.main.activity_create_post_team.*
import java.util.*

class CreatePostTeamActivity  : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_create_post_team)
        ...
        dialog= Dialog(this@CreatePostTeamActivity)
    ...
    private fun insertPost(d: Dialog) {
        ...
        PostDAO.add(post, UserInstance.getUserInstance()?.career.toString(),teamUid).addOnSuccessListener {
            ...
            teamActivityIntent.putExtra("teamUid",teamUid)
            hideProgressBar(d)
    ...
    private fun fetchLocation() {
        if(ActivityCompat.checkSelfPermission(this,android.Manifest.permission.ACCESS_FINE_LOCATION)!= PackageManager.PERMISSION_GRANTED
            ...
            Toast.makeText(this,"You need to provide permissions in order to share your location",
