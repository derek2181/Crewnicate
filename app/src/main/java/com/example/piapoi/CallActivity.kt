...
class CallActivity : AppCompatActivity() {
        ...
        databaseReference.child("Call").child(UserInstance.getUserInstance()?.uid.toString()).addChildEventListener(object :
            ...
            override fun onChildRemoved(snapshot: DataSnapshot) {
                    ...
                    if(childRemovedOnce){
                        ...
                        Toast.makeText(this@CallActivity,"The call has ended",Toast.LENGTH_SHORT).show()
                        leaveChannel()
                        finish()
    ...
    fun onLocalAudioMuteClicked(view: View) {
        ...
        if (iv.isSelected) {
            ...
            iv.isSelected = true
            iv.setColorFilter(resources.getColor(R.color.red), PorterDuff.Mode.MULTIPLY)
        }
...
//      mRtcEngine!!.setVideoProfile(Constants.VIDEO_PROFILE_360P, false) // Earlier than 2.3.0
    ...
    companion object {
        ...
        private val LOG_TAG = CallActivity::class.java.simpleName
